...
def mechanical_stiffness_matrix_3d_fuel_cell(C,num_gauss_points_in_domain, grad_shape_func_x_times_det_J_time_weight, grad_shape_func_x, grad_shape_func_y_times_det_J_time_weight, grad_shape_func_y, grad_shape_func_z_times_det_J_time_weight, grad_shape_func_z, \
    ...
    K12_mechanical = K12_mechanical_doamin_int + K12_mechanical_line_int #+ K12_mechanical_boundary_int #
    ...
    K22_mechanical = K22_mechanical_doamin_int + K22_mechanical_line_int #+ K22_mechanical_boundary_int #
    ...
    K32_mechanical = K32_mechanical_doamin_int + K32_mechanical_line_int #+ K32_mechanical_boundary_int #

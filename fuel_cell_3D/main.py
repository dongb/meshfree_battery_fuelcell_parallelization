...
shape_func_electrolyte = sparse.csr_matrix((np.array(shape_func_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
shape_func_times_det_J_time_weight_electrolyte = csr_matrix((np.array(shape_func_times_det_J_time_weight_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
grad_shape_func_x_electrolyte = csr_matrix((np.array(grad_shape_func_x_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
grad_shape_func_y_electrolyte = csr_matrix((np.array(grad_shape_func_y_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
grad_shape_func_x_times_det_J_time_weight_electrolyte = csr_matrix((np.array(grad_shape_func_x_times_det_J_time_weight_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
grad_shape_func_y_times_det_J_time_weight_electrolyte = csr_matrix((np.array(grad_shape_func_y_times_det_J_time_weight_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))

shape_func_electrode = csr_matrix((np.array(shape_func_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
shape_func_times_det_J_time_weight_electrode = csr_matrix((np.array(shape_func_times_det_J_time_weight_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
grad_shape_func_x_electrode = csr_matrix((np.array(grad_shape_func_x_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
grad_shape_func_y_electrode = csr_matrix((np.array(grad_shape_func_y_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
grad_shape_func_x_times_det_J_time_weight_electrode = csr_matrix((np.array(grad_shape_func_x_times_det_J_time_weight_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
grad_shape_func_y_times_det_J_time_weight_electrode = csr_matrix((np.array(grad_shape_func_y_times_det_J_time_weight_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))

shape_func_pore = csr_matrix((np.array(shape_func_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
shape_func_times_det_J_time_weight_pore = csr_matrix((np.array(shape_func_times_det_J_time_weight_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
grad_shape_func_x_pore = csr_matrix((np.array(grad_shape_func_x_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
grad_shape_func_y_pore = csr_matrix((np.array(grad_shape_func_y_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
grad_shape_func_x_times_det_J_time_weight_pore = csr_matrix((np.array(grad_shape_func_x_times_det_J_time_weight_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
grad_shape_func_y_times_det_J_time_weight_pore = csr_matrix((np.array(grad_shape_func_y_times_det_J_time_weight_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))

shape_func_mechanical = csr_matrix((np.array(shape_func_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
shape_func_times_det_J_time_weight_mechanical = csr_matrix((np.array(shape_func_times_det_J_time_weight_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
grad_shape_func_x_mechanical = csr_matrix((np.array(grad_shape_func_x_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
grad_shape_func_y_mechanical = csr_matrix((np.array(grad_shape_func_y_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
grad_shape_func_x_times_det_J_time_weight_mechanical = csr_matrix((np.array(grad_shape_func_x_times_det_J_time_weight_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
grad_shape_func_y_times_det_J_time_weight_mechanical = csr_matrix((np.array(grad_shape_func_y_times_det_J_time_weight_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))

if dimention == 3:
    grad_shape_func_z_electrolyte = csr_matrix((np.array(grad_shape_func_z_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
    grad_shape_func_z_times_det_J_time_weight_electrolyte = csr_matrix((np.array(grad_shape_func_z_times_det_J_time_weight_value_electrolyte), (np.array(phi_nonzero_index_row_electrolyte),np.array(phi_nonzero_index_column_electrolyte))), shape = (num_gauss_points_in_domain_electrolyte, num_nodes_electrolyte))
    
    grad_shape_func_z_electrode = csr_matrix((np.array(grad_shape_func_z_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
    grad_shape_func_z_times_det_J_time_weight_electrode = csr_matrix((np.array(grad_shape_func_z_times_det_J_time_weight_value_electrode), (np.array(phi_nonzero_index_row_electrode),np.array(phi_nonzero_index_column_electrode))), shape = (num_gauss_points_in_domain_electrode, num_nodes_electrode))
    
    grad_shape_func_z_pore = csr_matrix((np.array(grad_shape_func_z_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
    grad_shape_func_z_times_det_J_time_weight_pore = csr_matrix((np.array(grad_shape_func_z_times_det_J_time_weight_value_pore), (np.array(phi_nonzero_index_row_pore),np.array(phi_nonzero_index_column_pore))), shape = (num_gauss_points_in_domain_pore, num_nodes_pore))
    
    grad_shape_func_z_mechanical = csr_matrix((np.array(grad_shape_func_z_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
    grad_shape_func_z_times_det_J_time_weight_mechanical = csr_matrix((np.array(grad_shape_func_z_times_det_J_time_weight_value_mechanical), (np.array(phi_nonzero_index_row_mechanical),np.array(phi_nonzero_index_column_mechanical))), shape = (num_gauss_points_in_domain_mechanical, num_nodes_mechanical))
...
shape_func_b_electrolyte = csr_matrix((np.array(shape_func_b_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))
shape_func_b_times_det_J_b_time_weight_electrolyte = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))
grad_shape_func_b_x_electrolyte = csr_matrix((np.array(grad_shape_func_b_x_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))
grad_shape_func_b_y_electrolyte = csr_matrix((np.array(grad_shape_func_b_y_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))
...
grad_shape_func_b_y_times_det_J_b_time_weight_electrolyte = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))

shape_func_b_mechanical = csr_matrix((np.array(shape_func_b_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
shape_func_b_times_det_J_b_time_weight_mechanical = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
grad_shape_func_b_x_mechanical = csr_matrix((np.array(grad_shape_func_b_x_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
grad_shape_func_b_y_mechanical = csr_matrix((np.array(grad_shape_func_b_y_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
grad_shape_func_b_x_times_det_J_b_time_weight_mechanical = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
grad_shape_func_b_y_times_det_J_b_time_weight_mechanical = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))

if dimention == 3:
    grad_shape_func_b_z_electrolyte = csr_matrix((np.array(grad_shape_func_b_z_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))
    grad_shape_func_b_z_times_det_J_b_time_weight_electrolyte = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_electrolyte))

    grad_shape_func_b_z_mechanical = csr_matrix((np.array(grad_shape_func_b_z_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
    grad_shape_func_b_z_times_det_J_b_time_weight_mechanical = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_mechanical), (np.array(phi_b_nonzero_index_row_mechanical),np.array(phi_b_nonzero_index_column_mechanical))), shape = (num_gauss_points_on_boundary_electrolyte, num_nodes_mechanical))
...
if dimention == 3:
    ...
    if delta_point_source == 'False':
        ...
        shape_func_b_distributed_point_source_surface = csr_matrix((np.array(shape_func_b_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        shape_func_b_times_det_J_b_time_weight_distributed_point_source_surface = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        grad_shape_func_b_x_distributed_point_source_surface = csr_matrix((np.array(grad_shape_func_b_x_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        grad_shape_func_b_y_distributed_point_source_surface = csr_matrix((np.array(grad_shape_func_b_y_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        grad_shape_func_b_z_distributed_point_source_surface = csr_matrix((np.array(grad_shape_func_b_z_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        grad_shape_func_b_x_times_det_J_b_time_weight_distributed_point_source_surface = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        grad_shape_func_b_y_times_det_J_b_time_weight_distributed_point_source_surface = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))
        grad_shape_func_b_z_times_det_J_b_time_weight_distributed_point_source_surface = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_distributed_point_source_surface), (np.array(phi_b_nonzero_index_row_distributed_point_source_surface),np.array(phi_b_nonzero_index_column_distributed_point_source_surface))), shape = (num_gauss_points_distributed_point_source_surface, num_nodes_electrolyte))

shape_func_b_electrolyte_electrode_electrolyte = csr_matrix((np.array(shape_func_b_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))
shape_func_b_times_det_J_b_time_weight_electrolyte_electrode_electrolyte = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))
...
grad_shape_func_b_y_electrolyte_electrode_electrolyte = csr_matrix((np.array(grad_shape_func_b_y_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))
grad_shape_func_b_x_times_det_J_b_time_weight_electrolyte_electrode_electrolyte = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))
grad_shape_func_b_y_times_det_J_b_time_weight_electrolyte_electrode_electrolyte = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))

shape_func_b_electrolyte_electrode_electrode = csr_matrix((np.array(shape_func_b_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
shape_func_b_times_det_J_b_time_weight_electrolyte_electrode_electrode = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
grad_shape_func_b_x_electrolyte_electrode_electrode = csr_matrix((np.array(grad_shape_func_b_x_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
grad_shape_func_b_y_electrolyte_electrode_electrode = csr_matrix((np.array(grad_shape_func_b_y_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
grad_shape_func_b_x_times_det_J_b_time_weight_electrolyte_electrode_electrode = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
grad_shape_func_b_y_times_det_J_b_time_weight_electrolyte_electrode_electrode = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))

shape_func_b_electrode_pore_electrode = csr_matrix((np.array(shape_func_b_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
shape_func_b_times_det_J_b_time_weight_electrode_pore_electrode = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
grad_shape_func_b_x_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_x_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
grad_shape_func_b_y_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_y_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
grad_shape_func_b_x_times_det_J_b_time_weight_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
grad_shape_func_b_y_times_det_J_b_time_weight_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))

shape_func_b_electrode_pore_pore = csr_matrix((np.array(shape_func_b_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))
shape_func_b_times_det_J_b_time_weight_electrode_pore_pore = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))
grad_shape_func_b_x_electrode_pore_pore = csr_matrix((np.array(grad_shape_func_b_x_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))
grad_shape_func_b_y_electrode_pore_pore = csr_matrix((np.array(grad_shape_func_b_y_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))
grad_shape_func_b_x_times_det_J_b_time_weight_electrode_pore_pore = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))
grad_shape_func_b_y_times_det_J_b_time_weight_electrode_pore_pore = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))


shape_func_b_electrode = csr_matrix((np.array(shape_func_b_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
shape_func_b_times_det_J_b_time_weight_electrode = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
grad_shape_func_b_x_electrode = csr_matrix((np.array(grad_shape_func_b_x_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
grad_shape_func_b_y_electrode = csr_matrix((np.array(grad_shape_func_b_y_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
grad_shape_func_b_x_times_det_J_b_time_weight_electrode = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
grad_shape_func_b_y_times_det_J_b_time_weight_electrode = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))

shape_func_b_pore = csr_matrix((np.array(shape_func_b_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
shape_func_b_times_det_J_b_time_weight_pore = csr_matrix((np.array(shape_func_b_times_det_J_b_time_weight_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
grad_shape_func_b_x_pore = csr_matrix((np.array(grad_shape_func_b_x_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
grad_shape_func_b_y_pore = csr_matrix((np.array(grad_shape_func_b_y_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
grad_shape_func_b_x_times_det_J_b_time_weight_pore = csr_matrix((np.array(grad_shape_func_b_x_times_det_J_b_time_weight_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
grad_shape_func_b_y_times_det_J_b_time_weight_pore = csr_matrix((np.array(grad_shape_func_b_y_times_det_J_b_time_weight_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))

if dimention == 3:
    grad_shape_func_b_z_electrode = csr_matrix((np.array(grad_shape_func_b_z_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
    grad_shape_func_b_z_times_det_J_b_time_weight_electrode = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode), (np.array(phi_b_nonzero_index_row_electrode),np.array(phi_b_nonzero_index_column_electrode))), shape = (num_gauss_points_on_boundary_electrode, num_nodes_electrode))
    
    grad_shape_func_b_z_pore = csr_matrix((np.array(grad_shape_func_b_z_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
    grad_shape_func_b_z_times_det_J_b_time_weight_pore = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_pore), (np.array(phi_b_nonzero_index_row_pore),np.array(phi_b_nonzero_index_column_pore))), shape = (num_gauss_points_on_boundary_pore, num_nodes_pore))
    
    grad_shape_func_b_z_electrolyte_electrode_electrolyte = csr_matrix((np.array(grad_shape_func_b_z_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))
    grad_shape_func_b_z_electrolyte_electrode_electrode = csr_matrix((np.array(grad_shape_func_b_z_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
    grad_shape_func_b_z_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_z_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
    grad_shape_func_b_z_electrode_pore_pore = csr_matrix((np.array(grad_shape_func_b_z_value_electrode_pore_pore), (np.array(phi_b_nonzero_index_row_electrode_pore_pore),np.array(phi_b_nonzero_index_column_electrode_pore_pore))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_pore))
    grad_shape_func_b_z_times_det_J_b_time_weight_electrolyte_electrode_electrolyte = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrolyte),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrolyte))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrolyte))
    grad_shape_func_b_z_times_det_J_b_time_weight_electrolyte_electrode_electrode = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte_electrode_electrode), (np.array(phi_b_nonzero_index_row_electrolyte_electrode_electrode),np.array(phi_b_nonzero_index_column_electrolyte_electrode_electrode))), shape = (num_gauss_points_on_electrolyte_electrode_interface, num_nodes_electrode))
    grad_shape_func_b_z_times_det_J_b_time_weight_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
    grad_shape_func_b_z_times_det_J_b_time_weight_electrode_pore_electrode = csr_matrix((np.array(grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode_pore_electrode), (np.array(phi_b_nonzero_index_row_electrode_pore_electrode),np.array(phi_b_nonzero_index_column_electrode_pore_electrode))), shape = (num_gauss_points_on_electrode_pore_interface, num_nodes_electrode))
...
if dimention == 3:
    ...
    shape_func_n_nodes_n_nodes_electrolyte = csr_matrix((np.array(shape_func_value_electrolyte_nn), (np.array(phi_nonzero_index_row_electrolyte_nn),np.array(phi_nonzero_index_column_electrolyte_nn))), shape = (num_nodes_electrolyte, num_nodes_electrolyte))
    ...
    shape_func_n_nodes_n_nodes_electrode = csr_matrix((np.array(shape_func_value_electrode_nn), (np.array(phi_nonzero_index_row_electrode_nn),np.array(phi_nonzero_index_column_electrode_nn))), shape = (num_nodes_electrode, num_nodes_electrode))
    ...
    shape_func_n_nodes_n_nodes_pore = csr_matrix((np.array(shape_func_value_pore_nn), (np.array(phi_nonzero_index_row_pore_nn),np.array(phi_nonzero_index_column_pore_nn))), shape = (num_nodes_pore, num_nodes_pore))
...
if dimention == 3:
    ...
    # numba doesn't support csr_matrix, so get all these parameters and construct csr_matrix out of numba
    shape_func_line_n_nodes_electrolyte = csr_matrix((np.array(shape_func_value_electrolyte_line_nodes), (np.array(phi_nonzero_index_row_electrolyte_line_nodes),np.array(phi_nonzero_index_column_electrolyte_line_nodes))), shape = (num_source_line_gauss_points, num_nodes_electrolyte))
    
    shape_func_line_n_nodes_electrolyte_times_det_J_b_time_weight = shape_func_line_n_nodes_electrolyte.copy()
    # Get row indices for each non-zero element in the sparse matrix
    row_indices_electrolyte = np.repeat(np.arange(num_source_line_gauss_points), np.diff(shape_func_line_n_nodes_electrolyte_times_det_J_b_time_weight.indptr))
    shape_func_line_n_nodes_electrolyte_times_det_J_b_time_weight.data *= det_J_b_time_weight_line[row_indices_electrolyte]
    ...
    # numba doesn't support csr_matrix, so get all these parameters and construct csr_matrix out of numba
    shape_func_line_n_nodes_electrode = csr_matrix((np.array(shape_func_value_electrode_line_nodes), (np.array(phi_nonzero_index_row_electrode_line_nodes),np.array(phi_nonzero_index_column_electrode_line_nodes))), shape = (num_source_line_gauss_points, num_nodes_electrode))
    shape_func_line_n_nodes_electrode_times_det_J_b_time_weight = shape_func_line_n_nodes_electrode.copy()
    # Get row indices for each non-zero element in the sparse matrix
    row_indices_electrode = np.repeat(np.arange(num_source_line_gauss_points), np.diff(shape_func_line_n_nodes_electrode_times_det_J_b_time_weight.indptr))
    shape_func_line_n_nodes_electrode_times_det_J_b_time_weight.data *= det_J_b_time_weight_line[row_indices_electrode]
    ...
    # numba doesn't support csr_matrix, so get all these parameters and construct csr_matrix out of numba
    shape_func_line_n_nodes_pore = csr_matrix((np.array(shape_func_value_pore_line_nodes), (np.array(phi_nonzero_index_row_pore_line_nodes),np.array(phi_nonzero_index_column_pore_line_nodes))), shape = (num_source_line_gauss_points, num_nodes_pore))
    shape_func_line_n_nodes_pore_times_det_J_b_time_weight = shape_func_line_n_nodes_pore.copy()
    # Get row indices for each non-zero element in the sparse matrix
    row_indices_pore = np.repeat(np.arange(num_source_line_gauss_points), np.diff(shape_func_line_n_nodes_pore_times_det_J_b_time_weight.indptr))
    shape_func_line_n_nodes_pore_times_det_J_b_time_weight.data *= det_J_b_time_weight_line[row_indices_pore]
    ...
    # numba doesn't support csr_matrix, so get all these parameters and construct csr_matrix out of numba
    shape_func_fixed_point = csr_matrix((np.array(shape_func_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    shape_func_times_det_J_time_weight_fixed_point = csr_matrix((np.array(shape_func_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    grad_shape_func_x_fixed_point = csr_matrix((np.array(grad_shape_func_x_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    grad_shape_func_y_fixed_point = csr_matrix((np.array(grad_shape_func_y_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    grad_shape_func_x_times_det_J_time_weight_fixed_point = csr_matrix((np.array(grad_shape_func_x_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    grad_shape_func_y_times_det_J_time_weight_fixed_point = csr_matrix((np.array(grad_shape_func_y_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    grad_shape_func_z_fixed_point = csr_matrix((np.array(grad_shape_func_z_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))
    grad_shape_func_z_times_det_J_time_weight_fixed_point = csr_matrix((np.array(grad_shape_func_z_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (num_fixed_gauss_points, num_nodes_mechanical))

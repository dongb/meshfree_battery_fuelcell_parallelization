...
def mechanical_stiffness_matrix(C11, C12, C13, C22, C23, C33, E, x_nodes, num_gauss_points_in_domain, grad_shape_func_x_times_det_J_time_weight, grad_shape_func_x, grad_shape_func_y_times_det_J_time_weight, grad_shape_func_y):

...
# geometry:
differential_label = tk.Label(root, text='Differential Method', font=("Arial", 10, "bold"))
...
# geometry:
initial_conditions_label = tk.Label(root, text='Initial Conditions', font=("Arial", 10, "bold"))
...
# geometry:
material_properties_label = tk.Label(root, text='Material Properties', font=("Arial", 10, "bold"))
...
output_text_widget.grid(row=7, column=4, rowspan=4, columnspan=2, padx=10, pady=10,)

...
from get_nodes_gauss_points import get_x_nodes_single_grain_battery, get_x_nodes_fuel_cell_2d_toy, get_x_nodes_fuel_cell_3d_toy, get_x_nodes_multi_grain, x_G_and_def_J_time_weight_structured, x_G_b_and_det_J_b_structured, x_G_and_def_J_time_weight_multi_grains, x_G_b_and_det_J_b_multi_grains, x_G_and_def_J_time_weight_3d_fuelcell_domain, x_G_b_and_det_J_b_time_weight_3d_fuelcell_2d_boundary,x_G_b_and_det_J_b_time_weight_3d_fuelcell_2d_boundary_interface, x_G_and_det_J_line_3d_fuelcell_1d_boundary, get_x_nodes_fuel_cell_3d_toy_image,get_x_nodes_fuel_cell_2d_toy_image,x_G_and_def_J_time_weight_2d_fuelcell_domain, x_G_and_def_J_time_weight_2d_fuelcell_boundary, x_G_b_and_det_J_b_time_weight_2d_fuelcell_boundary

from shape_function_in_domain import compute_phi_M, shape_grad_shape_func, shape_func_n_nodes_by_n_nodes

from define_mechanical_stiffness_matrix import mechanical_stiffness_matrix_battery, mechanical_stiffness_matrix_fuel_cell, mechanical_stiffness_matrix_3d_fuel_cell, mechanical_force_matrix, mechanical_force_matrix_3d, mechanical_C_tensor, mechanical_C_tensor_3d
from define_diffusion_matrix_form import diffusion_matrix, diffusion_matrix_fuel_cell, diffusion_matrix_fuel_cell_distributed_point_source
...
if studied_physics == 'battery' and single_grain == 'True':
    ...
    x_nodes = np.array(get_x_nodes_single_grain_battery(n_nodes,n_intervals,x_min,x_max,y_min,y_max)) # types: array
...
if studied_physics == "battery" and single_grain == 'False':
    ...
    cell_nodes_list, grain_id, grain_id_bottom, grain_id_top, grain_id_left, grain_id_right, cell_shape, num_rec_cell, num_tri_cell, x_nodes, nodes_grain_id, bottom_boundary_cell_nodes_list, right_boundary_cell_nodes_list, top_boundary_cell_nodes_list, left_boundary_cell_nodes_list, repeated_vertex, interface_segments  = get_x_nodes_multi_grain(x_min, x_max, y_min, y_max, num_pixels_xyz, img_)
...
if studied_physics == "fuel cell":
    ...
    if single_grain == 'True':
        if dimention == 2:
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, point_source_coords, fixed_nodes_coords, nodes_id_left_electrolyte, nodes_id_right_electrode, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_left_electrolyte_y, cell_nodes_right_electrode_y = get_x_nodes_fuel_cell_2d_toy(x_min_electrolyte,x_max_electrolyte,y_min_electrolyte,y_max_electrolyte,x_min_electrode,x_max_electrode,y_min_electrode,y_max_electrode, n_intervals)
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, point_source_coords, fixed_nodes_coords, nodes_id_left_electrolyte, nodes_id_right_electrode, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_left_electrolyte_y, cell_nodes_right_electrode_y = [np.asarray(lst) for lst in [x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, point_source_coords, fixed_nodes_coords, nodes_id_left_electrolyte, nodes_id_right_electrode, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_left_electrolyte_y, cell_nodes_right_electrode_y]]
        if dimention == 3:
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, segments_source_coords, segments_fixed_coods, nodes_id_left_electrolyte, nodes_id_right_electrode, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrolyte_z, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_electrode_z, cell_nodes_left_electrolyte_x, cell_nodes_left_electrolyte_z, cell_nodes_right_electrode_x, cell_nodes_right_electrode_z  = get_x_nodes_fuel_cell_3d_toy(x_min_electrolyte,x_max_electrolyte,y_min_electrolyte,y_max_electrolyte,z_min_electrolyte, z_max_electrolyte, x_min_electrode,x_max_electrode,y_min_electrode,y_max_electrode,z_min_electrode, z_max_electrode, n_intervals)
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, segments_source_coords, segments_fixed_coods, nodes_id_left_electrolyte, nodes_id_right_electrode, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrolyte_z, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_electrode_z, cell_nodes_left_electrolyte_x, cell_nodes_left_electrolyte_z, cell_nodes_right_electrode_x, cell_nodes_right_electrode_z  = [np.asarray(lst) for lst in [x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, segments_source_coords, segments_fixed_coods, nodes_id_left_electrolyte, nodes_id_right_electrode, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrolyte_z, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_electrode_z, cell_nodes_left_electrolyte_x, cell_nodes_left_electrolyte_z, cell_nodes_right_electrode_x, cell_nodes_right_electrode_z ]]
    ...
    if single_grain == 'False':
        if dimention == 2:
            ...
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, x_nodes_pore, point_source, point_fixed, nodes_id_left_electrolyte, nodes_id_right_electrode, nodes_id_right_pore, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_pore_x,cell_nodes_pore_y, cell_nodes_left_electrolyte_y, cell_nodes_right_electrode_y, cell_nodes_right_pore_y,\
            cell_nodes_interface_electrode_electrolyte_x,cell_nodes_interface_electrode_electrolyte_y,\
            cell_nodes_interface_electrode_pore_x, cell_nodes_interface_electrode_pore_y  = get_x_nodes_fuel_cell_2d_toy_image(x_min,x_max,y_min,y_max,num_pixels_xyz, img_)
            
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, x_nodes_pore, point_source, point_fixed, nodes_id_left_electrolyte, nodes_id_right_electrode, nodes_id_right_pore, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_pore_x,cell_nodes_pore_y, cell_nodes_left_electrolyte_y, cell_nodes_right_electrode_y, cell_nodes_right_pore_y,\
            cell_nodes_interface_electrode_electrolyte_x,cell_nodes_interface_electrode_electrolyte_y,\
            cell_nodes_interface_electrode_pore_x, cell_nodes_interface_electrode_pore_y  = [np.asarray(lst) for lst in [x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, x_nodes_pore, point_source, point_fixed, nodes_id_left_electrolyte, nodes_id_right_electrode, nodes_id_right_pore, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_pore_x,cell_nodes_pore_y, cell_nodes_left_electrolyte_y, cell_nodes_right_electrode_y, cell_nodes_right_pore_y,\
            cell_nodes_interface_electrode_electrolyte_x,cell_nodes_interface_electrode_electrolyte_y,\
            cell_nodes_interface_electrode_pore_x, cell_nodes_interface_electrode_pore_y]]
            ...
            if delta_point_source == 'False':
                ...
                for i_dis in range(10):
                    cell_nodes_distributed_point_source_line_x.append([(x_max+x_min)/2, (x_max+x_min)/2])
                    cell_nodes_distributed_point_source_line_y.append([(y_max+y_min)/2+i_dis*(y_max-y_min)/100, (y_max+y_min)/2+(i_dis+1)*(y_max-y_min)/100])
        ...
        if dimention == 3:
            ...
            x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, x_nodes_pore, segments_source_coords, segments_fixed_coods, nodes_id_left_electrolyte, nodes_id_right_electrode, nodes_id_right_pore, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrolyte_z, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_electrode_z,cell_nodes_pore_x,cell_nodes_pore_y,cell_nodes_pore_z, cell_nodes_left_electrolyte_x, cell_nodes_left_electrolyte_z, cell_nodes_right_electrode_x, cell_nodes_right_electrode_z, cell_nodes_right_pore_x, cell_nodes_right_pore_z,\
            cell_nodes_interface_electrode_electrolyte_x,cell_nodes_interface_electrode_electrolyte_y,cell_nodes_interface_electrode_electrolyte_z,\
            cell_nodes_interface_electrode_pore_x, cell_nodes_interface_electrode_pore_y, cell_nodes_interface_electrode_pore_z= [np.asarray(lst) for lst in [x_nodes_mechanical, x_nodes_electrolyte, x_nodes_electrode, x_nodes_pore, segments_source_coords, segments_fixed_coods, nodes_id_left_electrolyte, nodes_id_right_electrode, nodes_id_right_pore, cell_nodes_electrolyte_x, cell_nodes_electrolyte_y, cell_nodes_electrolyte_z, cell_nodes_electrode_x, cell_nodes_electrode_y, cell_nodes_electrode_z,cell_nodes_pore_x,cell_nodes_pore_y,cell_nodes_pore_z, cell_nodes_left_electrolyte_x, cell_nodes_left_electrolyte_z, cell_nodes_right_electrode_x, cell_nodes_right_electrode_z, cell_nodes_right_pore_x, cell_nodes_right_pore_z,\
            cell_nodes_interface_electrode_electrolyte_x,cell_nodes_interface_electrode_electrolyte_y,cell_nodes_interface_electrode_electrolyte_z,\
...
if integral_method == 'gauss':
    if studied_physics == "battery":
        if single_grain == 'True':
            n_boundaries = 4
            x_G, det_J_time_weight = x_G_and_def_J_time_weight_structured(n_intervals, x_min,x_max,y_min,y_max,x_G_rec,weight_G_rec)
            x_G_b, det_J_b_time_weight = x_G_b_and_det_J_b_structured(n_boundaries, n_intervals, x_min, x_max, y_min, y_max, x_G_line, weight_G_line)
        ...
        if single_grain == 'False':
            ...
            x_G, det_J_time_weight, gauss_angle, Gauss_grain_id= x_G_and_def_J_time_weight_multi_grains(num_of_cell,x_G_domain_rec, x_G_domain_tri,weight_G_rec, weight_G_tri, cell_shape, cell_nodes_list, grain_id, angle, repeated_vertex)
            ...
            x_G_b, det_J_b_time_weight, gauss_angle_b, Gauss_b_grain_id = x_G_b_and_det_J_b_multi_grains(x_min, x_max, y_min, y_max, bottom_boundary_cell_nodes_list, right_boundary_cell_nodes_list, top_boundary_cell_nodes_list, left_boundary_cell_nodes_list, x_G_line, weight_G_line, grain_id_bottom, grain_id_top, grain_id_left, grain_id_right, angle)
    ...
    if studied_physics == "fuel cell":
        if dimention == 2:
            x_G_electrolyte, det_J_time_weight_electrolyte = x_G_and_def_J_time_weight_2d_fuelcell_domain(cell_nodes_electrolyte_x,cell_nodes_electrolyte_y,x_G_rec,weight_G_rec)
            x_G_electrode, det_J_time_weight_electrode = x_G_and_def_J_time_weight_2d_fuelcell_domain(cell_nodes_electrode_x,cell_nodes_electrode_y,x_G_rec,weight_G_rec)
            x_G_pore, det_J_time_weight_pore = x_G_and_def_J_time_weight_2d_fuelcell_domain(cell_nodes_pore_x,cell_nodes_pore_y,x_G_rec,weight_G_rec)

            if single_grain == 'True':
                x_G_b_electrolyte, det_J_b_time_weight_electrolyte = x_G_and_def_J_time_weight_2d_fuelcell_boundary(cell_nodes_left_electrolyte_y, x_min_electrolyte, x_G_line, weight_G_line)
                x_G_b_electrode, det_J_b_time_weight_electrode = x_G_and_def_J_time_weight_2d_fuelcell_boundary(cell_nodes_right_electrode_y, x_max_electrode, x_G_line, weight_G_line)
            else:
                x_G_b_electrolyte, det_J_b_time_weight_electrolyte = x_G_and_def_J_time_weight_2d_fuelcell_boundary(cell_nodes_left_electrolyte_y, x_min, x_G_line, weight_G_line)
                x_G_b_electrode, det_J_b_time_weight_electrode = x_G_and_def_J_time_weight_2d_fuelcell_boundary(cell_nodes_right_electrode_y, x_max, x_G_line, weight_G_line)
                x_G_b_pore, det_J_b_time_weight_pore = x_G_and_def_J_time_weight_2d_fuelcell_boundary(cell_nodes_right_pore_y, x_max, x_G_line, weight_G_line)
                x_G_b_interface_electrode_electrolyte, det_J_b_time_weight_interface_electrode_electrolyte = x_G_b_and_det_J_b_time_weight_2d_fuelcell_boundary(cell_nodes_interface_electrode_electrolyte_x,cell_nodes_interface_electrode_electrolyte_y,  x_G_line, weight_G_line)
                x_G_b_interface_electrode_pore, det_J_b_time_weight_interface_electrode_pore = x_G_b_and_det_J_b_time_weight_2d_fuelcell_boundary(cell_nodes_interface_electrode_pore_x,cell_nodes_interface_electrode_pore_y,  x_G_line, weight_G_line)
                if delta_point_source == 'False':
                    x_G_b_distributed_point_source_line, det_J_b_time_weight_distributed_point_source_line = x_G_b_and_det_J_b_time_weight_2d_fuelcell_boundary(np.asarray(cell_nodes_distributed_point_source_line_x), np.asarray(cell_nodes_distributed_point_source_line_y), x_G_line, weight_G_line)
        ...
        if dimention == 3:
            ...
            if single_grain == 'True':
                x_G_b_electrolyte, det_J_b_time_weight_electrolyte = x_G_b_and_det_J_b_time_weight_3d_fuelcell_2d_boundary(cell_nodes_left_electrolyte_x,cell_nodes_left_electrolyte_z, y_min_electrolyte, x_G_rec, weight_G_rec)
                x_G_b_electrode, det_J_b_time_weight_electrode = x_G_b_and_det_J_b_time_weight_3d_fuelcell_2d_boundary(cell_nodes_right_electrode_x,cell_nodes_right_electrode_z, y_max_electrode, x_G_rec, weight_G_rec)
            else:
            ...
            x_G_b_line_fixed, det_J_b_time_weight_line_fixed = x_G_and_det_J_line_3d_fuelcell_1d_boundary(segments_fixed_coods, x_G_line, weight_G_line)
...
if studied_physics == "fuel cell" and single_grain == 'True':
    a_electrode = c*(x_max_electrode-x_min_electrode)/n_intervals*np.ones(num_nodes_electrode)       # compact support size, shape: (num_nodes,)  
    a_electrolyte = a_electrode
    a_pore = a_electrode
    a_mechanical = c*(x_max_electrode-x_min_electrode)/n_intervals*np.ones(num_nodes_mechanical)
...
if studied_physics == "battery":
    ...
    M_P_x = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain)]) # partial M partial x
    M_P_y = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain)]) # partial M partial y

    phi_nonzero_index_row, phi_nonzero_index_column, phi_nonzerovalue_data, phi_P_x_nonzerovalue_data, phi_P_y_nonzerovalue_data, phi_P_z_nonzerovalue_data, M, M_P_x, M_P_y, M_P_z = compute_phi_M(x_G, Gauss_grain_id, x_nodes,nodes_grain_id, a, M, M_P_x, M_P_y, num_interface_segments, interface_nodes, BxByCxCy, IM_RKPM, single_grain)

    num_non_zero_phi_a = np.shape(np.array(phi_nonzero_index_row))[0]

    shape_func_value, shape_func_times_det_J_time_weight_value, grad_shape_func_x_value, grad_shape_func_y_value, grad_shape_func_z_value, grad_shape_func_x_times_det_J_time_weight_value, grad_shape_func_y_times_det_J_time_weight_value, grad_shape_func_z_times_det_J_time_weight_value = shape_grad_shape_func(x_G,x_nodes, num_non_zero_phi_a,HT0, M, M_P_x, M_P_y, differential_method, HT1, HT2, phi_nonzerovalue_data,phi_P_x_nonzerovalue_data,phi_P_y_nonzerovalue_data, phi_nonzero_index_row, phi_nonzero_index_column, det_J_time_weight, IM_RKPM)
    ...
    if dimention == 2:
        M_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_electrolyte)])
        M_P_x_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_electrolyte)]) # partial M partial x
        M_P_y_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_electrolyte)]) # partial M partial y
        
        M_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_electrode)])
        M_P_x_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_electrode)]) # partial M partial x
        M_P_y_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_electrode)]) # partial M partial y
        
        M_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_pore)])
        M_P_x_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_pore)]) # partial M partial x
        M_P_y_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_pore)]) # partial M partial y

        M_mechanical = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_mechanical)])
        M_P_x_mechanical = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_mechanical)])
        M_P_y_mechanical = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_in_domain_mechanical)])
    ...
    phi_nonzero_index_row_electrolyte = np.loadtxt('phi_nonzero_index_row_electrolyte.txt')
    phi_nonzero_index_column_electrolyte = np.loadtxt('phi_nonzero_index_column_electrolyte.txt')
    ...
    phi_nonzero_index_column_electrode = np.loadtxt('phi_nonzero_index_column_electrode.txt')
    ...
    phi_nonzero_index_row_mechanical = np.loadtxt('phi_nonzero_index_row_mechanical.txt')
    phi_nonzero_index_column_mechanical = np.loadtxt('phi_nonzero_index_column_mechanical.txt')
    ...
    shape_func_times_det_J_time_weight_value_electrolyte=np.loadtxt('shape_func_times_det_J_time_weight_value_electrolyte.txt')
    grad_shape_func_x_value_electrolyte=np.loadtxt('grad_shape_func_x_value_electrolyte.txt')
    grad_shape_func_y_value_electrolyte=np.loadtxt('grad_shape_func_y_value_electrolyte.txt')
    grad_shape_func_z_value_electrolyte=np.loadtxt('grad_shape_func_z_value_electrolyte.txt')
    grad_shape_func_x_times_det_J_time_weight_value_electrolyte=np.loadtxt('grad_shape_func_x_times_det_J_time_weight_value_electrolyte.txt')
    grad_shape_func_y_times_det_J_time_weight_value_electrolyte=np.loadtxt('grad_shape_func_y_times_det_J_time_weight_value_electrolyte.txt')
    grad_shape_func_z_times_det_J_time_weight_value_electrolyte=np.loadtxt('grad_shape_func_z_times_det_J_time_weight_value_electrolyte.txt')
    ...
    shape_func_times_det_J_time_weight_value_electrode=np.loadtxt('shape_func_times_det_J_time_weight_value_electrode.txt')
    grad_shape_func_x_value_electrode=np.loadtxt('grad_shape_func_x_value_electrode.txt')
    grad_shape_func_y_value_electrode=np.loadtxt('grad_shape_func_y_value_electrode.txt')
    grad_shape_func_x_times_det_J_time_weight_value_electrode = np.loadtxt('grad_shape_func_x_times_det_J_time_weight_value_electrode.txt.txt')
    grad_shape_func_y_times_det_J_time_weight_value_electrode = np.loadtxt('grad_shape_func_y_times_det_J_time_weight_value_electrode.txt.txt')
    grad_shape_func_z_value_electrode=np.loadtxt('grad_shape_func_z_value_electrode.txt')
    grad_shape_func_z_times_det_J_time_weight_value_electrode = np.loadtxt('grad_shape_func_z_times_det_J_time_weight_value_electrode.txt.txt')
    ...
    shape_func_times_det_J_time_weight_value_pore=np.loadtxt('shape_func_times_det_J_time_weight_value_pore.txt')
    ...
    grad_shape_func_x_times_det_J_time_weight_value_pore = np.loadtxt('grad_shape_func_x_times_det_J_time_weight_value_pore.txt.txt')
    grad_shape_func_y_times_det_J_time_weight_value_pore = np.loadtxt('grad_shape_func_y_times_det_J_time_weight_value_pore.txt.txt')
    grad_shape_func_z_value_pore=np.loadtxt('grad_shape_func_z_value_pore.txt')
    grad_shape_func_z_times_det_J_time_weight_value_pore = np.loadtxt('grad_shape_func_z_times_det_J_time_weight_value_pore.txt.txt')
    ...
    shape_func_times_det_J_time_weight_value_mechanical=np.loadtxt('shape_func_times_det_J_time_weight_value_mechanical.txt')
    grad_shape_func_x_value_mechanical=np.loadtxt('grad_shape_func_x_value_mechanical.txt')
    grad_shape_func_y_value_mechanical=np.loadtxt('grad_shape_func_y_value_mechanical.txt')
    grad_shape_func_x_times_det_J_time_weight_value_mechanical = np.loadtxt('grad_shape_func_x_times_det_J_time_weight_value_mechanical.txt.txt')
    grad_shape_func_y_times_det_J_time_weight_value_mechanical = np.loadtxt('grad_shape_func_y_times_det_J_time_weight_value_mechanical.txt.txt')
    grad_shape_func_z_value_mechanical=np.loadtxt('grad_shape_func_z_value_mechanical.txt')
    grad_shape_func_z_times_det_J_time_weight_value_mechanical = np.loadtxt('grad_shape_func_z_times_det_J_time_weight_value_mechanical.txt.txt')
...
if studied_physics == "battery":
    ...
    phi_b_nonzero_index_row, phi_b_nonzero_index_column, phi_b_nonzerovalue_data, phi_b_P_x_nonzerovalue_data, phi_b_P_y_nonzerovalue_data, phi_b_P_z_nonzerovalue_data, M_b, M_b_P_x, M_b_P_y, M_b_P_z = compute_phi_M(x_G_b, Gauss_b_grain_id, x_nodes, nodes_grain_id, a, M_b, M_b_P_x, M_b_P_y, num_interface_segments, interface_nodes, BxByCxCy,IM_RKPM, single_grain)


    num_non_zero_phi_a_b = np.shape(np.array(phi_b_nonzero_index_row))[0]

    shape_func_b_value, shape_func_b_times_det_J_b_time_weight_value, grad_shape_func_b_x_value, grad_shape_func_b_y_value, grad_shape_func_b_z_value, grad_shape_func_b_x_times_det_J_b_time_weight_value, grad_shape_func_b_y_times_det_J_b_time_weight_value, grad_shape_func_b_z_times_det_J_b_time_weight_value = shape_grad_shape_func(x_G_b,x_nodes, num_non_zero_phi_a_b,HT0, M_b, M_b_P_x, M_b_P_y, differential_method, HT1, HT2, phi_b_nonzerovalue_data, phi_b_P_x_nonzerovalue_data, phi_b_P_y_nonzerovalue_data, phi_b_nonzero_index_row, phi_b_nonzero_index_column, det_J_b_time_weight, IM_RKPM)
    ...
    if dimention == 2:
        M_b_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrolyte)],dtype=np.float64)
        M_b_P_x_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrolyte)],dtype=np.float64)
        M_b_P_y_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrolyte)],dtype=np.float64)
        ...
        M_b_mechanical = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrolyte)],dtype=np.float64)
        M_b_P_x_mechanical = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrolyte)],dtype=np.float64)
        M_b_P_y_mechanical = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrolyte)],dtype=np.float64)
    ...
    phi_b_nonzero_index_row_electrolyte = np.loadtxt('phi_b_nonzero_index_row_electrolyte.txt')
    phi_b_nonzero_index_column_electrolyte = np.loadtxt('phi_b_nonzero_index_column_electrolyte.txt')
    ...
    phi_b_nonzero_index_row_mechanical = np.loadtxt('phi_b_nonzero_index_row_mechanical.txt')
    phi_b_nonzero_index_column_mechanical = np.loadtxt('phi_b_nonzero_index_column_mechanical.txt')
    ...
    shape_func_b_times_det_J_b_time_weight_value_electrolyte=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_electrolyte.txt')
    grad_shape_func_b_x_value_electrolyte=np.loadtxt('grad_shape_func_b_x_value_electrolyte.txt')
    grad_shape_func_b_y_value_electrolyte=np.loadtxt('grad_shape_func_b_y_value_electrolyte.txt')
    grad_shape_func_b_z_value_electrolyte=np.loadtxt('grad_shape_func_b_z_value_electrolyte.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte.txt')
    ...
    shape_func_b_times_det_J_b_time_weight_value_mechanical=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_mechanical.txt')
    grad_shape_func_b_x_value_mechanical=np.loadtxt('grad_shape_func_b_x_value_mechanical.txt')
    grad_shape_func_b_y_value_mechanical=np.loadtxt('grad_shape_func_b_y_value_mechanical.txt')
    grad_shape_func_b_z_value_mechanical=np.loadtxt('grad_shape_func_b_z_value_mechanical.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_mechanical=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_mechanical.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_mechanical=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_mechanical.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_mechanical=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_mechanical.txt')
    ...
    if dimention == 2:
        M_b_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrode)],dtype=np.float64)
        M_b_P_x_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrode)],dtype=np.float64)
        M_b_P_y_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_electrode)],dtype=np.float64)
        ...
        M_b_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_pore)],dtype=np.float64)
        M_b_P_x_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_pore)],dtype=np.float64)
        M_b_P_y_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_boundary_pore)],dtype=np.float64)
        ...
        M_b_electrolyte_electrode_electrolyte= np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrolyte_electrode_interface)],dtype=np.float64)
        M_b_P_x_electrolyte_electrode_electrolyte= np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrolyte_electrode_interface)],dtype=np.float64)
        M_b_P_y_electrolyte_electrode_electrolyte = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrolyte_electrode_interface)],dtype=np.float64)
        ...
        M_b_electrolyte_electrode_electrode= np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrolyte_electrode_interface)],dtype=np.float64)
        M_b_P_x_electrolyte_electrode_electrode= np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrolyte_electrode_interface)],dtype=np.float64)
        M_b_P_y_electrolyte_electrode_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrolyte_electrode_interface)],dtype=np.float64)
        ...
        M_b_electrode_pore_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrode_pore_interface)],dtype=np.float64)
        M_b_P_x_electrode_pore_electrode= np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrode_pore_interface)],dtype=np.float64)
        M_b_P_y_electrode_pore_electrode = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrode_pore_interface)],dtype=np.float64)
        ...
        M_b_electrode_pore_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrode_pore_interface)],dtype=np.float64)
        M_b_P_x_electrode_pore_pore= np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrode_pore_interface)],dtype=np.float64)
        M_b_P_y_electrode_pore_pore = np.array([np.zeros((3,3)) for _ in range(num_gauss_points_on_electrode_pore_interface)],dtype=np.float64)
        ...
        if delta_point_source == 'False':
            ...
            # exit()
            M_b_distributed_point_source_line = np.array([np.zeros((3,3)) for _ in range(np.shape(x_G_b_distributed_point_source_line)[0])],dtype=np.float64)
            M_b_P_x_distributed_point_source_line= np.array([np.zeros((3,3)) for _ in range(np.shape(x_G_b_distributed_point_source_line)[0])],dtype=np.float64)
            M_b_P_y_distributed_point_source_line = np.array([np.zeros((3,3)) for _ in range(np.shape(x_G_b_distributed_point_source_line)[0])],dtype=np.float64)
            Gauss_b_grain_id_distributed_point_source_line  = 1*np.ones(np.shape(x_G_b_distributed_point_source_line)[0])
            phi_b_nonzero_index_row_distributed_point_source_line, phi_b_nonzero_index_column_distributed_point_source_line, phi_b_nonzerovalue_data_distributed_point_source_line, phi_b_P_x_nonzerovalue_data_distributed_point_source_line, phi_b_P_y_nonzerovalue_data_distributed_point_source_line,phi_b_P_z_nonzerovalue_data_distributed_point_source_line, M_b_distributed_point_source_line, M_b_P_x_distributed_point_source_line, M_b_P_y_distributed_point_source_line, M_b_P_z_distributed_point_source_line = compute_phi_M(np.array(x_G_b_distributed_point_source_line), Gauss_b_grain_id_distributed_point_source_line, x_nodes_electrolyte, nodes_grain_id_electrolyte, a_electrolyte, M_b_distributed_point_source_line, M_b_P_x_distributed_point_source_line, M_b_P_y_distributed_point_source_line, num_interface_segments, interface_nodes, BxByCxCy,IM_RKPM, single_grain)
            
            np.savetxt('phi_b_nonzero_index_row_distributed_point_source_line.txt', phi_b_nonzero_index_row_distributed_point_source_line)
            np.savetxt('phi_b_nonzero_index_column_distributed_point_source_line.txt', phi_b_nonzero_index_column_distributed_point_source_line)
            phi_b_nonzero_index_row_distributed_point_source_line = np.loadtxt('phi_b_nonzero_index_row_distributed_point_source_line.txt')
            phi_b_nonzero_index_column_distributed_point_source_line = np.loadtxt('phi_b_nonzero_index_column_distributed_point_source_line.txt')
            num_non_zero_phi_a_b_distributed_point_source_line = np.shape(np.array(phi_b_nonzero_index_row_distributed_point_source_line))[0]
    ...
    if dimention == 3:
        ...
        if delta_point_source == 'False':
            ...
            phi_b_nonzero_index_row_distributed_point_source_surface = np.loadtxt('phi_b_nonzero_index_row_distributed_point_source_surface.txt')
            phi_b_nonzero_index_column_distributed_point_source_surface = np.loadtxt('phi_b_nonzero_index_column_distributed_point_source_surface.txt')
    ...
    phi_b_nonzero_index_row_electrode = np.loadtxt('phi_b_nonzero_index_row_electrode.txt')
    phi_b_nonzero_index_column_electrode = np.loadtxt('phi_b_nonzero_index_column_electrode.txt')
    ...
    phi_b_nonzero_index_row_electrolyte_electrode_electrolyte = np.loadtxt('phi_b_nonzero_index_row_electrolyte_electrode_electrolyte.txt')
    phi_b_nonzero_index_column_electrolyte_electrode_electrolyte = np.loadtxt('phi_b_nonzero_index_column_electrolyte_electrode_electrolyte.txt')
    ...
    phi_b_nonzero_index_row_electrolyte_electrode_electrode = np.loadtxt('phi_b_nonzero_index_row_electrolyte_electrode_electrode.txt')
    phi_b_nonzero_index_column_electrolyte_electrode_electrode = np.loadtxt('phi_b_nonzero_index_column_electrolyte_electrode_electrode.txt')
    ...
    phi_b_nonzero_index_row_electrode_pore_electrode = np.loadtxt('phi_b_nonzero_index_row_electrode_pore_electrode.txt')
    phi_b_nonzero_index_column_electrode_pore_electrode = np.loadtxt('phi_b_nonzero_index_column_electrode_pore_electrode.txt')
    ...
    phi_b_nonzero_index_row_electrode_pore_pore = np.loadtxt('phi_b_nonzero_index_row_electrode_pore_pore.txt')
    phi_b_nonzero_index_column_electrode_pore_pore = np.loadtxt('phi_b_nonzero_index_column_electrode_pore_pore.txt')
    ...
    if dimention == 3:
        ...
        if delta_point_source == 'False':
            ...
            shape_func_b_value_distributed_point_source_surface=np.loadtxt('shape_func_b_value_distributed_point_source_surface.txt')
            shape_func_b_times_det_J_b_time_weight_value_distributed_point_source_surface=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_distributed_point_source_surface.txt')
            grad_shape_func_b_x_value_distributed_point_source_surface=np.loadtxt('grad_shape_func_b_x_value_distributed_point_source_surface.txt') 
            grad_shape_func_b_y_value_distributed_point_source_surface=np.loadtxt('grad_shape_func_b_y_value_distributed_point_source_surface.txt')
            grad_shape_func_b_z_value_distributed_point_source_surface=np.loadtxt('grad_shape_func_b_z_value_distributed_point_source_surface.txt')
            grad_shape_func_b_x_times_det_J_b_time_weight_value_distributed_point_source_surface=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_distributed_point_source_surface.txt')
            grad_shape_func_b_y_times_det_J_b_time_weight_value_distributed_point_source_surface=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_distributed_point_source_surface.txt')
            grad_shape_func_b_z_times_det_J_b_time_weight_value_distributed_point_source_surface=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_distributed_point_source_surface.txt')
    ...
    shape_func_b_value_electrolyte_electrode_electrolyte=np.loadtxt('shape_func_b_value_electrolyte_electrode_electrolyte.txt')
    shape_func_b_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte.txt')
    grad_shape_func_b_x_value_electrolyte_electrode_electrolyte=np.loadtxt('grad_shape_func_b_x_value_electrolyte_electrode_electrolyte.txt') 
    grad_shape_func_b_y_value_electrolyte_electrode_electrolyte=np.loadtxt('grad_shape_func_b_y_value_electrolyte_electrode_electrolyte.txt')
    grad_shape_func_b_z_value_electrolyte_electrode_electrolyte=np.loadtxt('grad_shape_func_b_z_value_electrolyte_electrode_electrolyte.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte_electrode_electrolyte.txt')
    ...
    shape_func_b_value_electrolyte_electrode_electrode=np.loadtxt('shape_func_b_value_electrolyte_electrode_electrode.txt')
    shape_func_b_times_det_J_b_time_weight_value_electrolyte_electrode_electrode=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_electrolyte_electrode_electrode.txt')
    grad_shape_func_b_x_value_electrolyte_electrode_electrode=np.loadtxt('grad_shape_func_b_x_value_electrolyte_electrode_electrode.txt') 
    grad_shape_func_b_y_value_electrolyte_electrode_electrode=np.loadtxt('grad_shape_func_b_y_value_electrolyte_electrode_electrode.txt')
    grad_shape_func_b_z_value_electrolyte_electrode_electrode=np.loadtxt('grad_shape_func_b_z_value_electrolyte_electrode_electrode.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte_electrode_electrode=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_electrolyte_electrode_electrode.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte_electrode_electrode=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_electrolyte_electrode_electrode.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte_electrode_electrode=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_electrolyte_electrode_electrode.txt')
    ...
    shape_func_b_value_electrode_pore_electrode=np.loadtxt('shape_func_b_value_electrode_pore_electrode.txt')
    shape_func_b_times_det_J_b_time_weight_value_electrode_pore_electrode=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_electrode_pore_electrode.txt')
    grad_shape_func_b_x_value_electrode_pore_electrode=np.loadtxt('grad_shape_func_b_x_value_electrode_pore_electrode.txt') 
    grad_shape_func_b_y_value_electrode_pore_electrode=np.loadtxt('grad_shape_func_b_y_value_electrode_pore_electrode.txt')
    grad_shape_func_b_z_value_electrode_pore_electrode=np.loadtxt('grad_shape_func_b_z_value_electrode_pore_electrode.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode_pore_electrode=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode_pore_electrode.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode_pore_electrode=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode_pore_electrode.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode_pore_electrode=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode_pore_electrode.txt')
    ...
    shape_func_b_value_electrode_pore_pore=np.loadtxt('shape_func_b_value_electrode_pore_pore.txt')
    shape_func_b_times_det_J_b_time_weight_value_electrode_pore_pore=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_electrode_pore_pore.txt')
    grad_shape_func_b_x_value_electrode_pore_pore=np.loadtxt('grad_shape_func_b_x_value_electrode_pore_pore.txt') 
    grad_shape_func_b_y_value_electrode_pore_pore=np.loadtxt('grad_shape_func_b_y_value_electrode_pore_pore.txt')
    grad_shape_func_b_z_value_electrode_pore_pore=np.loadtxt('grad_shape_func_b_z_value_electrode_pore_pore.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode_pore_pore=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode_pore_pore.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode_pore_pore=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode_pore_pore.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode_pore_pore=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode_pore_pore.txt')
    ...
    shape_func_b_times_det_J_b_time_weight_value_electrode=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_electrode.txt')
    grad_shape_func_b_x_value_electrode=np.loadtxt('grad_shape_func_b_x_value_electrode.txt') 
    grad_shape_func_b_y_value_electrode=np.loadtxt('grad_shape_func_b_y_value_electrode.txt')
    grad_shape_func_b_z_value_electrode=np.loadtxt('grad_shape_func_b_z_value_electrode.txt')
    grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_electrode.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_electrode.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_electrode.txt')
    ...
    shape_func_b_times_det_J_b_time_weight_value_pore=np.loadtxt('shape_func_b_times_det_J_b_time_weight_value_pore.txt')
    ...
    grad_shape_func_b_x_times_det_J_b_time_weight_value_pore=np.loadtxt('grad_shape_func_b_x_times_det_J_b_time_weight_value_pore.txt')
    grad_shape_func_b_y_times_det_J_b_time_weight_value_pore=np.loadtxt('grad_shape_func_b_y_times_det_J_b_time_weight_value_pore.txt')
    grad_shape_func_b_z_times_det_J_b_time_weight_value_pore=np.loadtxt('grad_shape_func_b_z_times_det_J_b_time_weight_value_pore.txt')
    ...
    if dimention == 2:
        M_electrolyte_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_electrolyte)])
        M_P_x_electrolyte_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_electrolyte)]) # partial M partial x
        M_P_y_electrolyte_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_electrolyte)]) # partial M partial y
        ...
        M_electrode_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_electrode)])
        M_P_x_electrode_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_electrode)]) # partial M partial x
        M_P_y_electrode_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_electrode)]) # partial M partial y
        ...
        M_P_x_pore_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_pore)]) # partial M partial x
        M_P_y_pore_nn = np.array([np.zeros((3,3)) for _ in range(num_nodes_pore)]) # partial M partial y
    ...
    phi_nonzero_index_row_electrode_nn = np.loadtxt('phi_nonzero_index_row_electrode_nn.txt')
    phi_nonzero_index_column_electrode_nn = np.loadtxt('phi_nonzero_index_column_electrode_nn.txt')
    ...
    phi_nonzero_index_row_electrolyte_nn = np.loadtxt('phi_nonzero_index_row_electrolyte_nn.txt')
    phi_nonzero_index_column_electrolyte_nn = np.loadtxt('phi_nonzero_index_column_electrolyte_nn.txt')
    ...
    phi_nonzero_index_column_pore_nn = np.loadtxt('phi_nonzero_index_column_pore_nn.txt')
    ...
    if dimention == 2:
        M_electrolyte_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])])
        M_P_x_electrolyte_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])]) # partial M partial x
        M_P_y_electrolyte_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])]) # partial M partial y
        phi_nonzero_index_row_electrolyte_source_nodes, phi_nonzero_index_column_electrolyte_source_nodes, phi_nonzerovalue_data_electrolyte_source_nodes, phi_P_x_nonzerovalue_data_electrolyte_source_nodes, phi_P_y_nonzerovalue_data_electrolyte_source_nodes, phi_P_z_nonzerovalue_data_electrolyte_source_nodes, M_electrolyte_source_nodes, M_P_x_electrolyte_source_nodes, M_P_y_electrolyte_source_nodes, M_P_z_electrolyte_source_nodes = compute_phi_M(point_source, Gauss_grain_id_electrolyte, x_nodes_electrolyte,nodes_grain_id_electrolyte, a_electrolyte, M_electrolyte_source_nodes, M_P_x_electrolyte_source_nodes, M_P_y_electrolyte_source_nodes, num_interface_segments, interface_nodes, BxByCxCy, IM_RKPM, single_grain)
        np.savetxt('phi_nonzero_index_row_electrolyte_source_nodes.txt',phi_nonzero_index_row_electrolyte_source_nodes)
        np.savetxt('phi_nonzero_index_column_electrolyte_source_nodes.txt', phi_nonzero_index_column_electrolyte_source_nodes)
        phi_nonzero_index_row_electrolyte_source_nodes = np.loadtxt('phi_nonzero_index_row_electrolyte_source_nodes.txt')
        phi_nonzero_index_column_electrolyte_source_nodes = np.loadtxt('phi_nonzero_index_column_electrolyte_source_nodes.txt')
        num_non_zero_phi_a_electrolyte_source_nodes = np.shape(np.array(phi_nonzero_index_row_electrolyte_source_nodes))[0]
        shape_func_value_electrolyte_source_nodes = shape_func_n_nodes_by_n_nodes(point_source,x_nodes_electrolyte, num_non_zero_phi_a_electrolyte_source_nodes,HT0, M_electrolyte_source_nodes, phi_nonzerovalue_data_electrolyte_source_nodes,phi_nonzero_index_row_electrolyte_source_nodes, phi_nonzero_index_column_electrolyte_source_nodes)
        np.savetxt('shape_func_value_electrolyte_source_nodes.txt', shape_func_value_electrolyte_source_nodes)
        shape_func_value_electrolyte_source_nodes = np.loadtxt('shape_func_value_electrolyte_source_nodes.txt')
        shape_func_source_nodes_electrolyte = csc_matrix((np.array(shape_func_value_electrolyte_source_nodes), (np.array(phi_nonzero_index_row_electrolyte_source_nodes),np.array(phi_nonzero_index_column_electrolyte_source_nodes))), shape = (np.shape(point_source)[0], num_nodes_electrolyte))
        print('shape function times 1 on line', np.max(np.sum(shape_func_source_nodes_electrolyte,axis=1)), np.min(np.sum(shape_func_source_nodes_electrolyte,axis=1)))

        M_electrode_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])])
        M_P_x_electrode_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])]) # partial M partial x
        M_P_y_electrode_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])]) # partial M partial y
        phi_nonzero_index_row_electrode_source_nodes, phi_nonzero_index_column_electrode_source_nodes, phi_nonzerovalue_data_electrode_source_nodes, phi_P_x_nonzerovalue_data_electrode_source_nodes, phi_P_y_nonzerovalue_data_electrode_source_nodes, phi_P_z_nonzerovalue_data_electrode_source_nodes, M_electrode_source_nodes, M_P_x_electrode_source_nodes, M_P_y_electrode_source_nodes, M_P_z_electrode_source_nodes = compute_phi_M(point_source, Gauss_grain_id_electrode, x_nodes_electrode,nodes_grain_id_electrode, a_electrode, M_electrode_source_nodes, M_P_x_electrode_source_nodes, M_P_y_electrode_source_nodes, num_interface_segments, interface_nodes, BxByCxCy, IM_RKPM, single_grain)
        np.savetxt('phi_nonzero_index_row_electrode_source_nodes.txt',phi_nonzero_index_row_electrode_source_nodes)
        np.savetxt('phi_nonzero_index_column_electrode_source_nodes.txt', phi_nonzero_index_column_electrode_source_nodes)
        phi_nonzero_index_row_electrode_source_nodes = np.loadtxt('phi_nonzero_index_row_electrode_source_nodes.txt')
        phi_nonzero_index_column_electrode_source_nodes = np.loadtxt('phi_nonzero_index_column_electrode_source_nodes.txt')
        num_non_zero_phi_a_electrode_source_nodes = np.shape(np.array(phi_nonzero_index_row_electrode_source_nodes))[0]
        shape_func_value_electrode_source_nodes = shape_func_n_nodes_by_n_nodes(point_source,x_nodes_electrode, num_non_zero_phi_a_electrode_source_nodes,HT0, M_electrode_source_nodes, phi_nonzerovalue_data_electrode_source_nodes,phi_nonzero_index_row_electrode_source_nodes, phi_nonzero_index_column_electrode_source_nodes)
        np.savetxt('shape_func_value_electrode_source_nodes.txt', shape_func_value_electrode_source_nodes)
        shape_func_value_electrode_source_nodes = np.loadtxt('shape_func_value_electrode_source_nodes.txt')
        shape_func_source_nodes_electrode = csc_matrix((np.array(shape_func_value_electrode_source_nodes), (np.array(phi_nonzero_index_row_electrode_source_nodes),np.array(phi_nonzero_index_column_electrode_source_nodes))), shape = (np.shape(point_source)[0], num_nodes_electrode))
        print('shape function times 1 on line', np.max(np.sum(shape_func_source_nodes_electrode,axis=1)), np.min(np.sum(shape_func_source_nodes_electrode,axis=1)))
        
        M_pore_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])])
        M_P_x_pore_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])]) # partial M partial x
        M_P_y_pore_source_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_source)[0])]) # partial M partial y
        phi_nonzero_index_row_pore_source_nodes, phi_nonzero_index_column_pore_source_nodes, phi_nonzerovalue_data_pore_source_nodes, phi_P_x_nonzerovalue_data_pore_source_nodes, phi_P_y_nonzerovalue_data_pore_source_nodes, phi_P_z_nonzerovalue_data_pore_source_nodes, M_pore_source_nodes, M_P_x_pore_source_nodes, M_P_y_pore_source_nodes, M_P_z_pore_source_nodes = compute_phi_M(point_source, Gauss_grain_id_pore, x_nodes_pore,nodes_grain_id_pore, a_pore, M_pore_source_nodes, M_P_x_pore_source_nodes, M_P_y_pore_source_nodes, num_interface_segments, interface_nodes, BxByCxCy, IM_RKPM, single_grain)
        np.savetxt('phi_nonzero_index_row_pore_source_nodes.txt',phi_nonzero_index_row_pore_source_nodes)
        np.savetxt('phi_nonzero_index_column_pore_source_nodes.txt', phi_nonzero_index_column_pore_source_nodes)
        phi_nonzero_index_row_pore_source_nodes = np.loadtxt('phi_nonzero_index_row_pore_source_nodes.txt')
        phi_nonzero_index_column_pore_source_nodes = np.loadtxt('phi_nonzero_index_column_pore_source_nodes.txt')
        num_non_zero_phi_a_pore_source_nodes = np.shape(np.array(phi_nonzero_index_row_pore_source_nodes))[0]
        shape_func_value_pore_source_nodes = shape_func_n_nodes_by_n_nodes(point_source,x_nodes_pore, num_non_zero_phi_a_pore_source_nodes,HT0, M_pore_source_nodes, phi_nonzerovalue_data_pore_source_nodes,phi_nonzero_index_row_pore_source_nodes, phi_nonzero_index_column_pore_source_nodes)
        np.savetxt('shape_func_value_pore_source_nodes.txt', shape_func_value_pore_source_nodes)
        shape_func_value_pore_source_nodes = np.loadtxt('shape_func_value_pore_source_nodes.txt')
        shape_func_source_nodes_pore = csc_matrix((np.array(shape_func_value_pore_source_nodes), (np.array(phi_nonzero_index_row_pore_source_nodes),np.array(phi_nonzero_index_column_pore_source_nodes))), shape = (np.shape(point_source)[0], num_nodes_pore))
        print('shape function times 1 on line', np.max(np.sum(shape_func_source_nodes_pore,axis=1)), np.min(np.sum(shape_func_source_nodes_pore,axis=1)))
        

        M_fixed_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_fixed)[0])])
        M_P_x_fixed_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_fixed)[0])]) # partial M partial x
        M_P_y_fixed_nodes = np.array([np.zeros((3,3)) for _ in range(np.shape(point_fixed)[0])]) # partial M partial y
        phi_nonzero_index_row_fixed_nodes, phi_nonzero_index_column_fixed_nodes, phi_nonzerovalue_data_fixed_nodes, phi_P_x_nonzerovalue_data_fixed_nodes, phi_P_y_nonzerovalue_data_fixed_nodes, phi_P_z_nonzerovalue_data_fixed_nodes, M_fixed_nodes, M_P_x_fixed_nodes, M_P_y_fixed_nodes, M_P_z_fixed_nodes = compute_phi_M(point_fixed, Gauss_grain_id_mechanical, x_nodes_mechanical,nodes_grain_id_mechanical, a_mechanical, M_fixed_nodes, M_P_x_fixed_nodes, M_P_y_fixed_nodes, num_interface_segments, interface_nodes, BxByCxCy, IM_RKPM, single_grain)
        np.savetxt('phi_nonzero_index_row_fixed_nodes.txt',phi_nonzero_index_row_fixed_nodes)
        np.savetxt('phi_nonzero_index_column_fixed_nodes.txt', phi_nonzero_index_column_fixed_nodes)
        phi_nonzero_index_row_fixed_nodes = np.loadtxt('phi_nonzero_index_row_fixed_nodes.txt')
        phi_nonzero_index_column_fixed_nodes = np.loadtxt('phi_nonzero_index_column_fixed_nodes.txt')
        ...
        shape_func_value_fixed_point, shape_func_times_det_J_time_weight_value_fixed_point, grad_shape_func_x_value_fixed_point, grad_shape_func_y_value_fixed_point, grad_shape_func_z_value_fixed_point, grad_shape_func_x_times_det_J_time_weight_value_fixed_point, grad_shape_func_y_times_det_J_time_weight_value_fixed_point, grad_shape_func_z_times_det_J_time_weight_value_fixed_point = shape_grad_shape_func(point_fixed,x_nodes_mechanical, num_non_zero_phi_a_fixed_nodes,HT0, M_fixed_nodes, M_P_x_fixed_nodes, M_P_y_fixed_nodes, differential_method, HT1, HT2, phi_nonzerovalue_data_fixed_nodes, phi_P_x_nonzerovalue_data_fixed_nodes, phi_P_y_nonzerovalue_data_fixed_nodes, phi_nonzero_index_row_fixed_nodes, phi_nonzero_index_column_fixed_nodes, det_J_time_weight_fixed_nodes, IM_RKPM)
        np.savetxt('shape_func_value_fixed_point.txt', shape_func_value_fixed_point)
        np.savetxt('grad_shape_func_x_value_fixed_point.txt',grad_shape_func_x_value_fixed_point)
        np.savetxt('grad_shape_func_y_value_fixed_point.txt', grad_shape_func_y_value_fixed_point)
        shape_func_value_fixed_point = np.loadtxt('shape_func_value_fixed_point.txt')
        grad_shape_func_x_value_fixed_point = np.loadtxt('grad_shape_func_x_value_fixed_point.txt')
        grad_shape_func_y_value_fixed_point = np.loadtxt('grad_shape_func_y_value_fixed_point.txt')
        shape_func_fixed_point = csc_matrix((np.array(shape_func_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (np.shape(point_fixed)[0], num_nodes_mechanical))
        grad_shape_func_x_fixed_point = csc_matrix((np.array(grad_shape_func_x_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (np.shape(point_fixed)[0], num_nodes_mechanical))
        grad_shape_func_y_fixed_point = csc_matrix((np.array(grad_shape_func_y_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_nodes),np.array(phi_nonzero_index_column_fixed_nodes))), shape = (np.shape(point_fixed)[0], num_nodes_mechanical))
    ...
    if dimention == 3:
        ...
        phi_nonzero_index_row_electrolyte_line_nodes = np.loadtxt('phi_nonzero_index_row_electrolyte_line_nodes.txt')
        phi_nonzero_index_column_electrolyte_line_nodes = np.loadtxt('phi_nonzero_index_column_electrolyte_line_nodes.txt')
        ...
        shape_func_value_electrolyte_line_nodes = np.loadtxt('shape_func_value_electrolyte_line_nodes.txt')
        ...
        phi_nonzero_index_row_electrode_line_nodes = np.loadtxt('phi_nonzero_index_row_electrode_line_nodes.txt')
        phi_nonzero_index_column_electrode_line_nodes = np.loadtxt('phi_nonzero_index_column_electrode_line_nodes.txt')
        ...
        shape_func_value_electrode_line_nodes = np.loadtxt('shape_func_value_electrode_line_nodes.txt')
        ...
        print('shape function times 1 on line', np.max(np.sum(shape_func_line_n_nodes_electrode,axis=1)), np.min(np.sum(shape_func_line_n_nodes_electrode,axis=1)))
        ...
        phi_nonzero_index_row_pore_line_nodes = np.loadtxt('phi_nonzero_index_row_pore_line_nodes.txt')
        phi_nonzero_index_column_pore_line_nodes = np.loadtxt('phi_nonzero_index_column_pore_line_nodes.txt')
        ...
        shape_func_value_pore_line_nodes = np.loadtxt('shape_func_value_pore_line_nodes.txt')
        ...
        M_fixed_line_nodes = np.array([np.zeros((4,4)) for _ in range(num_fixed_line_gauss_points)])
        M_P_x_fixed_line_nodes = np.array([np.zeros((4,4)) for _ in range(num_fixed_line_gauss_points)]) # partial M partial x
        M_P_y_fixed_line_nodes = np.array([np.zeros((4,4)) for _ in range(num_fixed_line_gauss_points)]) # partial M partial y
        M_P_z_fixed_line_nodes = np.array([np.zeros((4,4)) for _ in range(num_fixed_line_gauss_points)]) # partial M partial y
        ...
        phi_nonzero_index_row_fixed_line_nodes = np.loadtxt('phi_nonzero_index_row_fixed_line_nodes.txt')
        phi_nonzero_index_column_fixed_line_nodes = np.loadtxt('phi_nonzero_index_column_fixed_line_nodes.txt')

        num_non_zero_phi_a_fixed_line_nodes = np.shape(np.array(phi_nonzero_index_row_fixed_line_nodes))[0]
        ...
        shape_func_value_fixed_point=np.loadtxt('shape_func_value_fixed_point.txt')
        shape_func_times_det_J_time_weight_value_fixed_point=np.loadtxt('shape_func_times_det_J_time_weight_value_fixed_point.txt')
        grad_shape_func_x_value_fixed_point=np.loadtxt('grad_shape_func_x_value_fixed_point.txt') 
        grad_shape_func_y_value_fixed_point=np.loadtxt('grad_shape_func_y_value_fixed_point.txt')
        grad_shape_func_z_value_fixed_point=np.loadtxt('grad_shape_func_z_value_fixed_point.txt')
        grad_shape_func_x_times_det_J_time_weight_value_fixed_point=np.loadtxt('grad_shape_func_x_times_det_J_time_weight_value_fixed_point.txt')
        grad_shape_func_y_times_det_J_time_weight_value_fixed_point=np.loadtxt('grad_shape_func_y_times_det_J_time_weight_value_fixed_point.txt')
        grad_shape_func_z_times_det_J_time_weight_value_fixed_point=np.loadtxt('grad_shape_func_z_times_det_J_time_weight_value_fixed_point.txt')



        # numba doesn't support csc_matrix, so get all these parameters and construct csc_matrix out of numba
        shape_func_fixed_point = csc_matrix((np.array(shape_func_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        shape_func_times_det_J_time_weight_fixed_point = csc_matrix((np.array(shape_func_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        grad_shape_func_x_fixed_point = csc_matrix((np.array(grad_shape_func_x_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        grad_shape_func_y_fixed_point = csc_matrix((np.array(grad_shape_func_y_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        grad_shape_func_x_times_det_J_time_weight_fixed_point = csc_matrix((np.array(grad_shape_func_x_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        grad_shape_func_y_times_det_J_time_weight_fixed_point = csc_matrix((np.array(grad_shape_func_y_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        grad_shape_func_z_fixed_point = csc_matrix((np.array(grad_shape_func_z_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
        grad_shape_func_z_times_det_J_time_weight_fixed_point = csc_matrix((np.array(grad_shape_func_z_times_det_J_time_weight_value_fixed_point), (np.array(phi_nonzero_index_row_fixed_line_nodes),np.array(phi_nonzero_index_column_fixed_line_nodes))), shape = (num_fixed_line_gauss_points, num_nodes_mechanical))
...
if studied_physics == "fuel cell":
    ...
    print(np.max(np.sum(shape_func_electrolyte, axis=1)), np.min(np.sum(shape_func_electrolyte, axis=1)))
    print('shape func times 1 on boundary')
    print(np.max(np.sum(shape_func_b_electrolyte, axis=1)), np.min(np.sum(shape_func_b_electrolyte, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_x_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_x_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_x_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_x_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_y_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_y_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_y_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_y_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_x_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_x_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_y_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_y_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_z_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_z_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_z_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_z_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_z_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_z_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
    print('partial shape func partial x times x on boundary')
    print(np.max(np.sum(grad_shape_func_b_x_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
    print('partial shape func partial x times y on boundary')
    print(np.max(np.sum(grad_shape_func_b_x_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))       
    print('partial shape func partial y times x on boundary')
    print(np.max(np.sum(grad_shape_func_b_y_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
    print('partial shape func partial y times y on boundary')
    print(np.max(np.sum(grad_shape_func_b_y_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_x_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        print('partial shape func partial y times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_y_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        print('partial shape func partial z times x on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial z times y on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial z times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))

    #electrode
    print('check shape function in electrode')
    print('shape func times 1 in domain')
    print(np.max(np.sum(shape_func_electrode, axis=1)), np.min(np.sum(shape_func_electrode, axis=1)))
    print('shape func times 1 on boundary')
    print(np.max(np.sum(shape_func_b_electrode, axis=1)), np.min(np.sum(shape_func_b_electrode, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_x_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_x_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_x_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_x_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))        
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_y_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_y_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_y_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_y_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_x_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_x_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_y_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_y_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_z_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_z_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_z_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_z_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_z_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_z_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))

    print('partial shape func partial x times x on boundary')
    print(np.max(np.sum(grad_shape_func_b_x_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial x times y on boundary')
    print(np.max(np.sum(grad_shape_func_b_x_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))        
    print('partial shape func partial y times x on boundary')
    print(np.max(np.sum(grad_shape_func_b_y_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial y times y on boundary')
    print(np.max(np.sum(grad_shape_func_b_y_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_x_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial y times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_y_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial z times x on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
        print('partial shape func partial z times y on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
        print('partial shape func partial z times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))

    # pore:
    print('check shape function in pore')
    print('shape func times 1 in domain')
    print(np.max(np.sum(shape_func_pore, axis=1)), np.min(np.sum(shape_func_pore, axis=1)))
    print('shape func times 1 on boundary')
    print(np.max(np.sum(shape_func_b_pore, axis=1)), np.min(np.sum(shape_func_b_pore, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_x_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_x_pore.multiply(x_nodes_pore[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_x_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_x_pore.multiply(x_nodes_pore[:,1]), axis=1)))        
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_y_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_y_pore.multiply(x_nodes_pore[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_y_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_y_pore.multiply(x_nodes_pore[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_x_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_x_pore.multiply(x_nodes_pore[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_y_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_y_pore.multiply(x_nodes_pore[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_z_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_z_pore.multiply(x_nodes_pore[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_z_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_z_pore.multiply(x_nodes_pore[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_z_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_z_pore.multiply(x_nodes_pore[:,2]), axis=1)))

    print('partial shape func partial x times x on boundary')
    print(np.max(np.sum(grad_shape_func_b_x_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_pore.multiply(x_nodes_pore[:,0]), axis=1)))
    print('partial shape func partial x times y on boundary')
    print(np.max(np.sum(grad_shape_func_b_x_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_pore.multiply(x_nodes_pore[:,1]), axis=1)))        
    print('partial shape func partial y times x on boundary')
    print(np.max(np.sum(grad_shape_func_b_y_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_pore.multiply(x_nodes_pore[:,0]), axis=1)))
    print('partial shape func partial y times y on boundary')
    print(np.max(np.sum(grad_shape_func_b_y_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_pore.multiply(x_nodes_pore[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_x_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_pore.multiply(x_nodes_pore[:,2]), axis=1)))
        print('partial shape func partial y times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_y_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_pore.multiply(x_nodes_pore[:,2]), axis=1)))
        print('partial shape func partial z times x on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_pore.multiply(x_nodes_pore[:,0]), axis=1)))
        print('partial shape func partial z times y on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_pore.multiply(x_nodes_pore[:,1]), axis=1)))
        print('partial shape func partial z times z on boundary')
        print(np.max(np.sum(grad_shape_func_b_z_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_pore.multiply(x_nodes_pore[:,2]), axis=1)))
    
    # mechanical:
    print('check shape function mechanical')
    print('shape func times 1 in domain')
    print(np.max(np.sum(shape_func_mechanical, axis=1)), np.min(np.sum(shape_func_mechanical, axis=1)))

    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_x_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_x_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_x_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_x_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_y_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_y_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_y_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_y_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)))

    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_x_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_x_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)))
        
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_y_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_y_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)))

        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_z_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_z_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_z_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_z_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_z_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_z_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)))
    print('check shape function boundary mechanical')
    print('shape func times 1 in domain')
    print(np.max(np.sum(shape_func_b_mechanical, axis=1)), np.min(np.sum(shape_func_b_mechanical, axis=1)))

    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_b_x_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_b_x_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_b_y_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_b_y_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)))

    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_b_x_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)))
        
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_b_y_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)))

        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_b_z_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_mechanical.multiply(x_nodes_mechanical[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_b_z_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_mechanical.multiply(x_nodes_mechanical[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_b_z_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_mechanical.multiply(x_nodes_mechanical[:,2]), axis=1)))
        
    # fixed nodes
    print('check shape function on fixed node')
    print('shape func times 1 in domain')
    print(np.max(np.sum(shape_func_fixed_point, axis=1)), np.min(np.sum(shape_func_fixed_point, axis=1)))

    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_x_fixed_point.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_x_fixed_point.multiply(x_nodes_mechanical[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_x_fixed_point.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_x_fixed_point.multiply(x_nodes_mechanical[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_y_fixed_point.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_y_fixed_point.multiply(x_nodes_mechanical[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_y_fixed_point.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_y_fixed_point.multiply(x_nodes_mechanical[:,1]), axis=1)))

    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_x_fixed_point.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_x_fixed_point.multiply(x_nodes_mechanical[:,2]), axis=1)))
        
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_y_fixed_point.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_y_fixed_point.multiply(x_nodes_mechanical[:,2]), axis=1)))

        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_z_fixed_point.multiply(x_nodes_mechanical[:,0]), axis=1)), np.min(np.sum(grad_shape_func_z_fixed_point.multiply(x_nodes_mechanical[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_z_fixed_point.multiply(x_nodes_mechanical[:,1]), axis=1)), np.min(np.sum(grad_shape_func_z_fixed_point.multiply(x_nodes_mechanical[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_z_fixed_point.multiply(x_nodes_mechanical[:,2]), axis=1)), np.min(np.sum(grad_shape_func_z_fixed_point.multiply(x_nodes_mechanical[:,2]), axis=1)))

    # source
    if dimention == 2:
        print('check shape function on source node')
        print('shape func times 1 in domain')
        print(np.max(np.sum(shape_func_source_nodes_pore, axis=1)), np.min(np.sum(shape_func_source_nodes_pore, axis=1)))
        print(np.max(np.sum(shape_func_source_nodes_electrolyte, axis=1)), np.min(np.sum(shape_func_source_nodes_electrolyte, axis=1)))
        print(np.max(np.sum(shape_func_source_nodes_electrode, axis=1)), np.min(np.sum(shape_func_source_nodes_electrode, axis=1)))
    if dimention == 3:
        print('check shape function on source node')
        print('shape func times 1 in domain')
        print(np.max(np.sum(shape_func_line_n_nodes_electrolyte, axis=1)), np.min(np.sum(shape_func_line_n_nodes_electrolyte, axis=1)))
        print(np.max(np.sum(shape_func_line_n_nodes_electrode, axis=1)), np.min(np.sum(shape_func_line_n_nodes_electrode, axis=1)))
        print(np.max(np.sum(shape_func_line_n_nodes_pore, axis=1)), np.min(np.sum(shape_func_line_n_nodes_pore, axis=1)))
    
    # interface
    print('electrolyte-electrode-interface: electolyte')
    print(np.max(np.sum(shape_func_b_electrolyte_electrode_electrolyte, axis=1)), np.min(np.sum(shape_func_b_electrolyte_electrode_electrolyte, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrolyte.multiply(x_nodes_electrolyte[:,2]), axis=1)))
    
    print('electrolyte-electrode-interface: electrode')
    print(np.max(np.sum(shape_func_b_electrolyte_electrode_electrode, axis=1)), np.min(np.sum(shape_func_b_electrolyte_electrode_electrode, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrolyte_electrode_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
    
    print('electrode-pore-interface: electrode')
    print(np.max(np.sum(shape_func_b_electrode_pore_electrode, axis=1)), np.min(np.sum(shape_func_b_electrode_pore_electrode, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrode_pore_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode_pore_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrode_pore_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode_pore_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrode_pore_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode_pore_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrode_pore_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode_pore_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_b_x_electrode_pore_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode_pore_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_b_y_electrode_pore_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode_pore_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrode_pore_electrode.multiply(x_nodes_electrode[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode_pore_electrode.multiply(x_nodes_electrode[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrode_pore_electrode.multiply(x_nodes_electrode[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode_pore_electrode.multiply(x_nodes_electrode[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrode_pore_electrode.multiply(x_nodes_electrode[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode_pore_electrode.multiply(x_nodes_electrode[:,2]), axis=1)))
    
    print('electrode-pore-interface: pore')
    print(np.max(np.sum(shape_func_b_electrode_pore_pore, axis=1)), np.min(np.sum(shape_func_b_electrode_pore_pore, axis=1)))
    print('partial shape func partial x times x in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrode_pore_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode_pore_pore.multiply(x_nodes_pore[:,0]), axis=1)))
    print('partial shape func partial x times y in domain')
    print(np.max(np.sum(grad_shape_func_b_x_electrode_pore_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode_pore_pore.multiply(x_nodes_pore[:,1]), axis=1)))
    print('partial shape func partial y times x in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrode_pore_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode_pore_pore.multiply(x_nodes_pore[:,0]), axis=1)))
    print('partial shape func partial y times y in domain')
    print(np.max(np.sum(grad_shape_func_b_y_electrode_pore_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode_pore_pore.multiply(x_nodes_pore[:,1]), axis=1)))
    if dimention == 3:
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_b_x_electrode_pore_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_electrode_pore_pore.multiply(x_nodes_pore[:,2]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_b_y_electrode_pore_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_electrode_pore_pore.multiply(x_nodes_pore[:,2]), axis=1)))
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrode_pore_pore.multiply(x_nodes_pore[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode_pore_pore.multiply(x_nodes_pore[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrode_pore_pore.multiply(x_nodes_pore[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode_pore_pore.multiply(x_nodes_pore[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_b_z_electrode_pore_pore.multiply(x_nodes_pore[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_electrode_pore_pore.multiply(x_nodes_pore[:,2]), axis=1)))
    
    # n by n
    print('check on domain nodes, n by n')
    print(np.max(np.sum(shape_func_n_nodes_n_nodes_electrolyte, axis=1)), np.min(np.sum(shape_func_n_nodes_n_nodes_electrolyte, axis=1)))
    print(np.max(np.sum(shape_func_n_nodes_n_nodes_electrode, axis=1)), np.min(np.sum(shape_func_n_nodes_n_nodes_electrode, axis=1)))
    print(np.max(np.sum(shape_func_n_nodes_n_nodes_pore, axis=1)), np.min(np.sum(shape_func_n_nodes_n_nodes_pore, axis=1)))
    
    if dimention == 2 and delta_point_source == 'False':
        print('distributed point source')
        print(np.max(np.sum(shape_func_b_distributed_point_source_line, axis=1)), np.min(np.sum(shape_func_b_distributed_point_source_line, axis=1)))
        print('partial shape func partial x times x in domain')
        print(np.max(np.sum(grad_shape_func_b_x_distributed_point_source_line.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_distributed_point_source_line.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial x times y in domain')
        print(np.max(np.sum(grad_shape_func_b_x_distributed_point_source_line.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_distributed_point_source_line.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial y times x in domain')
        print(np.max(np.sum(grad_shape_func_b_y_distributed_point_source_line.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_distributed_point_source_line.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial y times y in domain')
        print(np.max(np.sum(grad_shape_func_b_y_distributed_point_source_line.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_distributed_point_source_line.multiply(x_nodes_electrolyte[:,1]), axis=1)))
    
    if dimention == 3 and delta_point_source == 'False':
        print('distributed point source')
        print(np.max(np.sum(shape_func_b_distributed_point_source_surface, axis=1)), np.min(np.sum(shape_func_b_distributed_point_source_surface, axis=1)))
        print('partial shape func partial x times x in domain')
        print(np.max(np.sum(grad_shape_func_b_x_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_x_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial x times y in domain')
        print(np.max(np.sum(grad_shape_func_b_x_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_x_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial x times z in domain')
        print(np.max(np.sum(grad_shape_func_b_x_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_x_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        
        print('partial shape func partial y times x in domain')
        print(np.max(np.sum(grad_shape_func_b_y_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_y_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial y times y in domain')
        print(np.max(np.sum(grad_shape_func_b_y_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_y_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial y times z in domain')
        print(np.max(np.sum(grad_shape_func_b_y_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_y_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,2]), axis=1)))
        
        print('partial shape func partial z times x in domain')
        print(np.max(np.sum(grad_shape_func_b_z_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,0]), axis=1)), np.min(np.sum(grad_shape_func_b_z_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,0]), axis=1)))
        print('partial shape func partial z times y in domain')
        print(np.max(np.sum(grad_shape_func_b_z_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,1]), axis=1)), np.min(np.sum(grad_shape_func_b_z_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,1]), axis=1)))
        print('partial shape func partial z times z in domain')
        print(np.max(np.sum(grad_shape_func_b_z_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,2]), axis=1)), np.min(np.sum(grad_shape_func_b_z_distributed_point_source_surface.multiply(x_nodes_electrolyte[:,2]), axis=1)))
...
if studied_physics == "battery":
    ...
    for ii in range(nt):
        ...
        K_mechanical = mechanical_stiffness_matrix_battery(C11, C12, C13, C22, C23, C33,num_gauss_points_in_domain, grad_shape_func_x_times_det_J_time_weight, grad_shape_func_x, grad_shape_func_y_times_det_J_time_weight, grad_shape_func_y)
...
if studied_physics == "fuel cell":
    if single_grain == 'True':
        h_E = (y_max_electrolyte-y_min_electrolyte)/n_intervals # maximum element size
    else:
    ...
    if dimention == 2:
        ...
        """
        if delta_point_source == 'False':
            phi_old_node_electrolyte = shape_func_source_nodes_electrolyte*phi_old_electrolyte
            i_HOR = i_0*np.exp(0.5*Fday/R/T*(-phi_old_node_electrolyte+V_app-E_0)) 
            
            distributed_point_source_electrolyte = -0.008762*np.ones(np.shape(x_G_b_distributed_point_source_line)[0])/(y_max-y_min)*2*5#i_HOR/2###
        ...
        while diff>6.0e-7:
            ...
            if delta_point_source == 'True':
                K_electrolyte, f_electrolyte = diffusion_matrix_fuel_cell(dimention, point_source_electrolyte, shape_func_source_nodes_electrolyte, g_diretchlet_electrolyte, beta_Nitsche_electrolyte, normal_vector_x_electrolyte, normal_vector_y_electrolyte, diffusion_electrolyte,grad_shape_func_x_electrolyte,grad_shape_func_y_electrolyte,grad_shape_func_x_times_det_J_time_weight_electrolyte,grad_shape_func_y_times_det_J_time_weight_electrolyte,\
                        shape_func_b_electrolyte,shape_func_b_times_det_J_b_time_weight_electrolyte,grad_shape_func_b_x_times_det_J_b_time_weight_electrolyte, grad_shape_func_b_y_times_det_J_b_time_weight_electrolyte, shape_func_b_times_det_J_b_time_weight_electrolyte_electrode_electrolyte, interface_source_electrolyte_electrode_electrolyte)
            else:
                K_electrolyte, f_electrolyte = diffusion_matrix_fuel_cell_distributed_point_source(dimention, distributed_point_source_electrolyte, shape_func_b_times_det_J_b_time_weight_distributed_point_source_line, g_diretchlet_electrolyte, beta_Nitsche_electrolyte, normal_vector_x_electrolyte, normal_vector_y_electrolyte, diffusion_electrolyte,grad_shape_func_x_electrolyte,grad_shape_func_y_electrolyte,grad_shape_func_x_times_det_J_time_weight_electrolyte,grad_shape_func_y_times_det_J_time_weight_electrolyte,\
                        shape_func_b_electrolyte,shape_func_b_times_det_J_b_time_weight_electrolyte,grad_shape_func_b_x_times_det_J_b_time_weight_electrolyte, grad_shape_func_b_y_times_det_J_b_time_weight_electrolyte, shape_func_b_times_det_J_b_time_weight_electrolyte_electrode_electrolyte, interface_source_electrolyte_electrode_electrolyte)
            ...
            K_electrode, f_electrode = diffusion_matrix_fuel_cell(dimention, point_source_electrode, shape_func_source_nodes_electrode, g_diretchlet_electrode, beta_Nitsche_electrode, normal_vector_x_electrode, normal_vector_y_electrode, diffusion_electrode,grad_shape_func_x_electrode,grad_shape_func_y_electrode,grad_shape_func_x_times_det_J_time_weight_electrode,grad_shape_func_y_times_det_J_time_weight_electrode,\
                     shape_func_b_electrode,shape_func_b_times_det_J_b_time_weight_electrode,grad_shape_func_b_x_times_det_J_b_time_weight_electrode, grad_shape_func_b_y_times_det_J_b_time_weight_electrode, shape_func_interface_electrode, interface_source_electrode)
            
            K_pore, f_pore = diffusion_matrix_fuel_cell(dimention, point_source_pore, shape_func_source_nodes_pore, g_diretchlet_pore, beta_Nitsche_pore, normal_vector_x_pore, normal_vector_y_pore, diffusion_pore,grad_shape_func_x_pore,grad_shape_func_y_pore,grad_shape_func_x_times_det_J_time_weight_pore,grad_shape_func_y_times_det_J_time_weight_pore,\
                     shape_func_b_pore,shape_func_b_times_det_J_b_time_weight_pore,grad_shape_func_b_x_times_det_J_b_time_weight_pore, grad_shape_func_b_y_times_det_J_b_time_weight_pore, shape_func_b_times_det_J_b_time_weight_electrode_pore_pore, interface_source_electrode_pore_pore)
            ...
            C_new_electrode = results_new[num_nodes_electrolyte:(num_nodes_electrolyte+num_nodes_electrode)]
            ...
            if delta_point_source == 'True':
                # source on triple junctions
                phi_new_node_electrolyte = shape_func_source_nodes_electrolyte*phi_old_electrolyte
                i_HOR = i_0*np.exp(0.5*Fday/R/T*(-phi_new_node_electrolyte+V_app-E_0)) 
                # initialize the old results
                ...
                # flux will be applied
                point_source_electrolyte = point_source_electrolyte_new *0.2 + point_source_electrolyte_old*0.8
                point_source_pore = point_source_pore_new *0.2 + point_source_pore_old*0.8
                point_source_electrode = point_source_electrode_new *0.2 + point_source_electrode_old*0.8
        ...
        potential_on_GP_save_electrolyte = np.zeros((num_gauss_points_in_domain_electrolyte, 3))
        potential_on_GP_save_electrolyte[:,:2] = x_G_electrolyte
        potential_on_GP_save_electrolyte[:,2] = shape_func_electrolyte*phi_new_electrolyte
        ...
        fig1 = plt.figure()
        plt.scatter(potential_on_GP_save_electrolyte[:, 0], potential_on_GP_save_electrolyte[:, 1], c=potential_on_GP_save_electrolyte[:,2])
        plt.colorbar()
        plt.title('potention in electrolyte (on GP)')

        fig2 = plt.figure()
        plt.scatter(C_on_GP_save_electrode[:, 0], C_on_GP_save_electrode[:, 1], c=C_on_GP_save_electrode[:,2])
        plt.colorbar()
        plt.title('concentration in electrode (on GP)')

        fig3 = plt.figure()
        plt.scatter(C_on_GP_save_pore[:, 0], C_on_GP_save_pore[:, 1], c=C_on_GP_save_pore[:,2])
        plt.colorbar()
        ...
        mu_electrode_array = nu_electrode*np.ones(num_gauss_points_in_domain_electrode)
        mu_electrolyte_array = nu_electrolyte*np.ones(num_gauss_points_in_domain_electrolyte)
        mu_mechanical = np.concatenate((mu_electrolyte_array, mu_electrode_array))

        print('define mechanical stiffness matrix')

        C11, C12, C13, C22, C23, C33 = mechanical_C_tensor(num_gauss_points_in_domain_mechanical, D_damage, lambda_mechanical, mu_mechanical, Gauss_angle_mechanical)
        
        K_mechanical = mechanical_stiffness_matrix_fuel_cell(C11, C12, C13, C22, C23, C33,num_gauss_points_in_domain_mechanical, grad_shape_func_x_times_det_J_time_weight_mechanical, grad_shape_func_x_mechanical, grad_shape_func_y_times_det_J_time_weight_mechanical, grad_shape_func_y_mechanical,\
                                                   beta_Nitsche_mechanical,\
                                                    shape_func_b_mechanical, shape_func_b_times_det_J_b_time_weight_mechanical, \
                                                    grad_shape_func_b_x_times_det_J_b_time_weight_mechanical, grad_shape_func_b_y_times_det_J_b_time_weight_mechanical,\
        ...
        dc_G_domain = np.concatenate((dc_G_domain_electrolyte, (shape_func_electrode*C_new_electrode-c_boundary)))
        ...
        # exit()
        # rotate the diffusivity
        R11 = (np.cos(Gauss_angle_mechanical)).reshape(num_gauss_points_in_domain_mechanical,1)
        R12 = (np.sin(Gauss_angle_mechanical)).reshape(num_gauss_points_in_domain_mechanical,1)
        R21 = (-np.sin(Gauss_angle_mechanical)).reshape(num_gauss_points_in_domain_mechanical,1)
        R22 = (np.cos(Gauss_angle_mechanical)).reshape(num_gauss_points_in_domain_mechanical,1)
        ...
        beta_fuelcell_expansion_coefficient_electrolyte = beta_fuelcell_expansion_coefficient*np.ones(num_gauss_points_in_domain_electrolyte)
        ...
        beta_1 = np.concatenate((beta_fuelcell_expansion_coefficient_electrolyte, beta_fuelcell_expansion_coefficient_electrode)).reshape(num_gauss_points_in_domain_mechanical,1)*(dc_G_domain.reshape(num_gauss_points_in_domain_mechanical,1))
        beta_2 = np.concatenate((beta_fuelcell_expansion_coefficient_electrolyte, beta_fuelcell_expansion_coefficient_electrode)).reshape(num_gauss_points_in_domain_mechanical,1)*(dc_G_domain.reshape(num_gauss_points_in_domain_mechanical,1))
        ...
        # solve the mechenical part without damage
        f_mechanical = mechanical_force_matrix(x_G_mechanical, C11, C12, C13, C22, C23, C33, epsilon_D1, epsilon_D2, epsilon_D3, grad_shape_func_x_times_det_J_time_weight_mechanical, grad_shape_func_y_times_det_J_time_weight_mechanical)
        ...
        print(np.max(x_G_mechanical[:num_gauss_points_in_domain_electrolyte,0]),np.min(x_G_mechanical[:num_gauss_points_in_domain_electrolyte,0]))
        print(np.max(x_G_mechanical[:num_gauss_points_in_domain_electrolyte,1]),np.min(x_G_mechanical[:num_gauss_points_in_domain_electrolyte,1]))
        print(np.max(x_G_mechanical[num_gauss_points_in_domain_electrolyte:,0]),np.min(x_G_mechanical[num_gauss_points_in_domain_electrolyte:,0]))
        print(np.max(x_G_mechanical[num_gauss_points_in_domain_electrolyte:,1]),np.min(x_G_mechanical[num_gauss_points_in_domain_electrolyte:,1]))
    ...
    if dimention == 3:
        ...
        while diff >6.0e-4:
            ...
            if delta_point_source == 'True':
                ...
                # flux will be applied
                line_source_electrolyte = line_source_electrolyte_new *0.5 + line_source_electrolyte_old*0.5
                line_source_pore = line_source_pore_new *0.5 + line_source_pore_old*0.5
                line_source_electrode = line_source_electrode_new *0.5 + line_source_electrode_old*0.5
            ...
            interface_source_electrolyte_electrode_electrolyte_new = -i_solid/2
            interface_source_electrolyte_electrode_electrode_new = i_solid/2/96485
            interface_source_electrolyte_electrode_electrolyte = interface_source_electrolyte_electrode_electrolyte_new*0.5 + interface_source_electrolyte_electrode_electrolyte_old*0.5
            interface_source_electrolyte_electrode_electrode = interface_source_electrolyte_electrode_electrode_new*0.5 + interface_source_electrolyte_electrode_electrode_old*0.5
            interface_source_electrolyte_electrode_electrolyte_old = interface_source_electrolyte_electrode_electrolyte.copy()
            interface_source_electrolyte_electrode_electrode_old = interface_source_electrolyte_electrode_electrode.copy()
            ...
            interface_source_electrode_pore_electrode_new = -J_interface
            interface_source_electrode_pore_pore_new = J_interface
            interface_source_electrode_pore_electrode = interface_source_electrode_pore_electrode_new*0.5 + interface_source_electrode_pore_electrode_old*0.5
            interface_source_electrode_pore_pore = interface_source_electrode_pore_pore_new*0.5 + interface_source_electrode_pore_pore_old*0.5
            interface_source_electrode_pore_electrode_old = interface_source_electrode_pore_electrode.copy()
            interface_source_electrode_pore_pore_old = interface_source_electrode_pore_pore.copy()
        ...
        sc8 = ax8.scatter(x_nodes_electrolyte[:, 0], x_nodes_electrolyte[:, 1],x_nodes_electrolyte[:, 2], c=shape_func_n_nodes_n_nodes_electrolyte*phi_new_electrolyte)
        plt.colorbar(sc8, ax=ax8)

        fig9 = plt.figure()
        ax9 = fig9.add_subplot(111, projection='3d')
        sc9 = ax9.scatter(x_nodes_electrode[:, 0], x_nodes_electrode[:, 1],x_nodes_electrode[:, 2], c=shape_func_n_nodes_n_nodes_electrode*C_new_electrode)
        plt.colorbar(sc9, ax=ax9)

        fig10 = plt.figure()
        ax10 = fig10.add_subplot(111, projection='3d')
        sc10 = ax10.scatter(x_nodes_pore[:, 0], x_nodes_pore[:, 1],x_nodes_pore[:, 2], c=shape_func_n_nodes_n_nodes_pore*C_new_pore)
